	...
	// }).addTo(map);
		...
		$.getJSON("ktrk_localish_locations.geojson",function(data){
			...
			search.on('search:locationfound', function(e) {
				...
				$(clicked_icon).siblings().attr("src", "img/icon-01.png").removeClass("selected-icon")
			...
			$(".leaflet-marker-icon").on("click", function(e){
				...
				$(this).siblings().attr("src", "img/icon-01.png").removeClass("selected-icon")
			...
			$(document.body).on('click', '.new-close-button' ,function(){
				...
				$(".selected-icon").attr("src", "img/icon-01.png").removeClass("selected-icon")
